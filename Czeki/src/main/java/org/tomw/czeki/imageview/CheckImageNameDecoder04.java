...
public class CheckImageNameDecoder04 implements CheckImageNameDecoder {

    private String sampleNameFront="1234F";
    private String sampleNameBack="1234B";
    ...
    public boolean isCorrectFormat(String fileName) {
        ...
        return basename.matches("^\\d{4}[FB]");
    }
