...
public class CheckImageNameDecoder01 implements CheckImageNameDecoder{

    private String sampleNameFront="EA5DA3CC376212610009F";
    private String sampleNameBack="EA5DA3CC376212610009B";

    @Override
    public boolean isCorrectFormat(String fileName) {
        String basename= FilenameUtils.getBaseName(fileName);
        return basename.matches("^\\w{8}\\d{4}\\w{8}[FB]");
    }
