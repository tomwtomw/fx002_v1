...
public class CheckImageNameDecoder03 implements CheckImageNameDecoder {
    private String sampleNameFront="2017-09-21-1234-F";
    private String sampleNameBack="2017-09-21-1234-B";
    ...
    public boolean isCorrectFormat(String fileName) {
        ...
        return basename.matches("^\\d{4}-\\d{2}-\\d{2}-\\d{4}-[FB]");
    }
    ...
    public String getCheckNumber(String fileName) {
        //2017-09-21-1234-F
        String basename= FilenameUtils.getBaseName(fileName);
        return basename.substring(11, 15);
    }
